...
BOOST_INCLUDE = r"C:/ProgramData/chocolatey/lib/boost-msvc-14.3/include/boost-1_84"
...
def calculate_table(output_name, data_file_path, exp_patterns_path, num_patterns=15, min_support_param=0.01):
    ...
    commands = ["g++", explanations_path, lighthouse_path,"-o", "program"]#, f"-I{BOOST_INCLUDE}"
